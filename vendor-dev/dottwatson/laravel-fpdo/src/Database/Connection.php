...
namespace Dottwatson\Fpdo\Database;

// use Dottwatson\Fpdo\Php7\FakePdo;
//use Illuminate\Database\Connection as BaseConnection;

use Dottwatson\Fpdo\DataParser;
use Dottwatson\Fpdo\Exceptions\FpdoException;
    ...
    public function close()
    {
        ...
        foreach($databases as $database=>$tables){
            foreach($tables as $table=>$tableInfo){
                $parser = TableData::resolveParser($database,$table,DataParser::WRITE_MODE);
